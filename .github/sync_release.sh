...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-TaitoF2_MiSTer.git"
CORE_NAME=(Arcade-TaitoF2)
...
UPSTREAM_CORE_NAME=(Arcade-TaitoF2)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-TaitoF2.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-TaitoF2.rbf)
